...
export function StudyIcon({ size }) {
  return (
    <Svg size={size}>
      <path d="M12 7v14" />
      <path d="M16 12h2" />
...
export function FlaskIcon({ size }) {
  return (
    <Svg size={size}>
...
export function LearnedIcon({ size }) {
  return (
    <Svg size={size}>
...
export function ReviewIcon({ size }) {
  return (
    <Svg size={size}>
      <path d="M12 18V5" />
...
export function MissedIcon({ size }) {
  return (
    <Svg size={size}>
